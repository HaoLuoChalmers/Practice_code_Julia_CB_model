...
plt.subplot(221)
a = plt.plot(t,xBio,color="black",label = L"HCM FBA")
b = plt.plot(tKim,BKim,color="black","--",label = L"HCM EM")
plt.errorbar(tBio,Bio,Bioerr,fmt="ko",color="black",label = L"DATA")
...
plt.axis([0, 8.55,0,1])
plt.legend(bbox_to_anchor=(0.505, 0.99), loc=1, borderaxespad=0.,fontsize=13,frameon=false)
